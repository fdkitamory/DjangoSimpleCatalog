...
urlpatterns = patterns('mycatalog.catalog.views',
    ...
    url(r'^(?P<url>([\w-]+/){1,3})$', 'categories'), #Категории первого уровня
    # url(r'^(?P<url>[\w-]+/[\w-]+/)$', 'categories'), #Категории первого уровня
    # url(r'^(?P<url>[\w-]+/[\w-]+/[\w-]+/)$', 'categories'), #Категории первого уровня
